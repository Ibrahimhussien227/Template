package com.example.template.fragments.update
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.et_updateEmail.setText(args.currentUser.email)
    ...
    private fun updateItem() {
        ...
        val email = et_updateEmail.text.toString()
        val age = Integer.parseInt(et_updateAge.text.toString())

        if (inputCheck(firstName, email, et_updateAge.text)) {
            val update = User(args.currentUser.id, firstName, email, age)

            mUserViewModel.update(update)
    ...
    private fun deleteUser() {
        ...
        builder.setMessage("Are you sure ${args.currentUser.firstName}?")
        builder.create().show()
    }
}